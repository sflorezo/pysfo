...
def check_reporting(subdata, INDICATOR, FREQ, report_percen = None, start_date = None, end_date = None, REF_AREA_all = False):
    ...
    with suppress_print():
        ...
        json_metadata_path = Path(os.path.dirname(__file__)) / "IFS.customization"
        ...
        try :
            size_orderer = pysfo_pull.wbWDI.get(indicator = "NY.GDP.MKTP.CD")
        ...
        iso_3 = cc.convert(all_ref_areas, src = "ISO2", to = "ISO3")
