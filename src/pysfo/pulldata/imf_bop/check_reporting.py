...
ignore = ['G7',
    ...
    'Currenecy Composition Reporters',
    'All International Investment Positions',
    'Special Purpose Entities Reporters'
]
...
def check_reporting(subdata, INDICATOR, FREQ, report_percen = None, start_date = None, end_date = None, REF_AREA_all = False):
    ...
    if len(check):
        ...
        Error constructing reporter_check for {INDICATOR} ({FREQ}). Please check construction.
